...
class _Screen2State extends State<Screen2> {
  ...
  void _onItemTapped(int index) async {
    ...
    if (index == 1) { // Assuming the plus icon is at index 2
      String apiUrl =
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
                    ...
                    children: [
                      Column(
                        children: [
                          ...
                          Container(
                            child: Text('${snapshot.data!['location']['name'].toString()} - ${snapshot.data!['location']['region'].toString()} - ${snapshot.data!['location']['country'].toString()}', style: const TextStyle(
                                color: Colors.white,
                                fontSize: 20,
                                fontWeight: FontWeight.bold
                            ),),
        ...
        //   backgroundColor: Color(0xFFb34cce),
        //   items: [
